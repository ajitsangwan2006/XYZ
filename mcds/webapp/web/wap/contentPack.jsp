...
<option>
	<onevent type="onpick"> 
	<go href="<%=response.encodeURL(com.gisil.mcds.web.servlet.wap.SubContentPackServlet.SERVLET_PATH)%>" method="post"> 
	<postfield name="type" value="<%=(String)info.getValue()%>"/>
	</go>
	</onevent> 
<%=""+_counter+". "+(String)info.getDisplayName()%>
</option>
<%
if(_counter >= end)
	break;
