...
import com.gisil.mcds.web.controller.ui.SuiContentManagementMenuController;
import com.gisil.mcds.web.servlet.MCDSServiceServlet;

/**
 * Provides a List of AggregatorInfo
 * 
 * @author 
 *
 */
public class ContentMgtMenuServlet extends MCDSServiceServlet {
	...
	public static final String SERVLET_PATH = "ContentMgtMenu";
	...
	protected void processIt(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try{
			...
			auditTrail.setAdditionalInfo2("Load all aggregators");
			RequestDispatcher requestDispatcher = request.getRequestDispatcher(SuiContentManagementMenuController.PAGE_PATH)	;
