...
/**
 * Filter requests from Device end
 * @author 
 *
 */
public class DeviceSecurityFilter implements Filter {
	...
	public DeviceSecurityFilter() {
		_log = LogUtil.getLogger(DeviceSecurityFilter.class);
	}
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if ( aggregatorId == null )
		{
     	...
     	if (m_session == null && session != null) {
			m_session = (String) session.getAttribute("m_session");
		}
